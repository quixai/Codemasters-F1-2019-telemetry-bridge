...
namespace Bridge.Codemasters.Quix
{
    public class StreamingService
    {
        ...
        public StreamingService(string topic, string brokerAddress, string certificatePath, string username, string password, bool includeOtherDrivers)
        {
            // Create a client which holds generic details for creating input and output topics
            var secuOptions = new SecurityOptions(certificatePath, username, password);
            var client = new StreamingClient(brokerAddress, secuOptions);
