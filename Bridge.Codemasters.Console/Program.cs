...
namespace Bridge.Codemasters.Console
{
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            var streamingService = new StreamingService(consoleConfig.KafkaConfig.Topic,
                consoleConfig.KafkaConfig.BrokerAddress,
                consoleConfig.KafkaConfig.Security.CACertificatePath,
                consoleConfig.KafkaConfig.Security.Username,
                consoleConfig.KafkaConfig.Security.Password,
